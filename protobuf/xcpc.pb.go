...
func (*XCPCTransaction) Descriptor() ([]byte, []int) {
	return fileDescriptor_xcpc_bd50240750f78a69, []int{0}
}
...
type XCPCTransaction_Send_ struct {
	Send *XCPCTransaction_Send `protobuf:"bytes,1,opt,name=send,proto3,oneof"`
}
type XCPCTransaction_Broadcast_ struct {
	Broadcast *XCPCTransaction_Broadcast `protobuf:"bytes,2,opt,name=broadcast,proto3,oneof"`
}
...
func (*XCPCTransaction_Send) Descriptor() ([]byte, []int) {
	return fileDescriptor_xcpc_bd50240750f78a69, []int{0, 0}
}
...
type XCPCTransaction_Broadcast struct {
	...
	Feefraction          int32    `protobuf:"varint,3,opt,name=feefraction,proto3" json:"feefraction,omitempty"`
...
func (*XCPCTransaction_Broadcast) Descriptor() ([]byte, []int) {
	return fileDescriptor_xcpc_bd50240750f78a69, []int{0, 1}
}
...
func init() {
	proto.RegisterType((*XCPCTransaction)(nil), "xcpc_proto.XCPCTransaction")
	proto.RegisterType((*XCPCTransaction_Send)(nil), "xcpc_proto.XCPCTransaction.Send")
	proto.RegisterType((*XCPCTransaction_Broadcast)(nil), "xcpc_proto.XCPCTransaction.Broadcast")
}

func init() { proto.RegisterFile("xcpc.proto", fileDescriptor_xcpc_bd50240750f78a69) }

var fileDescriptor_xcpc_bd50240750f78a69 = []byte{
	// 259 bytes of a gzipped FileDescriptorProto
	,
}
